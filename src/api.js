...
export const getEvents = async () => {
  ...
  if (token) {
    ...
    const url = 'hhttps://02ep2xk2eh.execute-api.us-east-2.amazonaws.com/dev/api/get-events' + '/' + token;
  ...
  if (!accessToken || !tokenCheck) {
    ...
    if (!code) {
      const results = await axios.get(
        "https://02ep2xk2eh.execute-api.us-east-2.amazonaws.com/dev/api/get-auth-url"
      );
